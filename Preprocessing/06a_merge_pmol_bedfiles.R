...
data <- multmerge("/cluster/projects/hoffmangroup/data_samanthawilson/", "*fmol_all.bed_intersect_hg38_aggbywindow.bed")
...
write.csv(data, file = "/cluster/projects/hoffmangroup/data_samanthawilson/data.bed")
